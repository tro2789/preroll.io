---
title: Core Concepts
description: Understand preroll.io's data model — organizations, clients, shows, episodes, and how they connect.
---
...
preroll.io is API-first. The REST API is the product — the web UI, client portal, and MCP server are all consumers of the same API. Integrations (Frame.io, Transistor, Google Drive, Vimeo, YouTube) connect via OAuth or API keys and are orchestrated through preroll.io rather than replaced by it.
