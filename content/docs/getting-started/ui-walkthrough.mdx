...
description: A visual tour of PreRoll's interface and key screens.
---


This guide walks through each major screen in PreRoll so you know where everything lives. Each section includes a screenshot and describes the key actions available on that page.
...
PreRoll uses a consistent navigation structure:
