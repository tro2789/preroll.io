...
description: Automate podcast production workflows with the preroll.io community node for n8n.
---

## Overview

The `n8n-nodes-preroll` community node lets you interact with preroll.io directly from n8n workflows. Use it to automate episode creation, monitor pipeline progress, trigger actions when deliverables are approved, and more.
