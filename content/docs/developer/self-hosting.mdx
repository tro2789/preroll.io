---
title: Self-Hosting
description: Deploy PreRoll on your own infrastructure with full feature access and no plan restrictions.
---
...
PreRoll can send email notifications for deliverable approvals, revision requests, and other events. Configure these SMTP variables:
