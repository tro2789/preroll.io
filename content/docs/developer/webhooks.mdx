---
title: Webhooks
description: Receive real-time HTTP notifications when events occur in PreRoll.
---

## Overview

Webhooks allow your systems to receive HTTP POST notifications when events happen in PreRoll. Configure webhook endpoints in **Settings → Developer → Webhooks**.
...
3. In PreRoll, go to **Settings → Developer → Webhooks** and create a new endpoint with the n8n webhook URL
