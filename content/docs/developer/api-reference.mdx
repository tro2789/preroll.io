---
title: API Reference
description: Authenticate and interact with the PreRoll REST API using API keys.
---
...
Keys are prefixed with `pr_` and are only shown once at creation. They are stored as SHA-256 hashes — PreRoll never stores your raw key.
