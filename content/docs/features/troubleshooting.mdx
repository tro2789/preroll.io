...
This page covers common issues you might encounter while using PreRoll, along with their solutions.
...
**Symptoms:** You're logged out while actively using PreRoll.
...
1. **Check file size** — Ensure you're within your plan's limit (Free: 100MB, Pro: 500MB, Studio: 2GB)
2. **Check storage quota** — View usage in Settings > Organization
...
1. Check your current storage usage in **Settings > Organization**
2. Delete unused assets to free space
3. Upgrade your plan for more storage
4. Consider linking external files instead of uploading (Frame.io, Google Drive, Vimeo links)
...
1. **Check spam/junk folder** — PreRoll emails sometimes land in spam initially
