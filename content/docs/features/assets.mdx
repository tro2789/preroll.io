...
PreRoll includes built-in asset management for the lightweight files that make up your podcast production — cover art, thumbnails, intro/outro clips, music beds, and branding packages. Assets are stored on Cloudflare R2 for fast global delivery.

{/* Screenshot: Assets Library — /docs/screenshots/assets.png */}

## Asset Levels

Assets exist at two levels in PreRoll:
...
Cover art deserves special mention as it's displayed throughout PreRoll:
...
- Shown in the PreRoll UI on episode cards
