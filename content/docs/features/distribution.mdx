---
title: "Distribution"
description: "Publish episodes to Transistor.fm, Castopod, and YouTube with metadata management and scheduled publishing."
---
...
[Castopod](https://castopod.org) is a self-hosted, open-source podcast hosting platform. If you run your own Castopod instance, preroll.io can publish episodes directly to it.
...
See [Castopod Integration](/docs/developer/integrations/castopod) for detailed setup and troubleshooting.
