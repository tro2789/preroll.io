...
A show in PreRoll represents a single podcast series. Each show belongs to a client and contains episodes. Shows are where you configure the production pipeline, branding, distribution, and templates that apply to all episodes within.
...
Upload your show's cover art directly to PreRoll. This image is:
